  ...
  return (
    <>
        <div className="relative flex w-80 h-[400px] flex-col justify-between rounded-xl bg-gray-800 bg-clip-border text-gray-700 shadow-md">
            <Image alt={`foto do ${aluno.nome}`} src={aluno.img} width={40} height={40} className="relative mx-4 -mt-10 self-center overflow-hidden rounded-full text-white shadow-lg shadow-blue-gray-500/40 bg-black" />
